...
func HandleFulfillmentConfirm(w http.ResponseWriter, r *http.Request) {
	var req aicollect.FulfillmentConfirmRequest
	...
	resp, err := aicollect.NewService(cfg).ConfirmFulfillment(r.Context(), req)
	if err != nil {
